...
{
    public partial class iscrizione : System.Web.UI.Page
    {
        ...
        protected void txtUsername_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtUsername.Text != string.Empty)
            {
                if (Convert.ToBoolean(
                    ...
                    txtUsername.Style.Add(HtmlTextWriterStyle.BorderColor, "#f66");
                else
                    txtUsername.Style.Add(HtmlTextWriterStyle.BorderColor, "#6f6");
            }
            else
                txtUsername.Style.Add(HtmlTextWriterStyle.BorderColor, "#ced4da");
        ...
        protected void txtMail_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtMail.Text != string.Empty)
            {
                if (Convert.ToBoolean(
                    ...
                    txtMail.Style.Add(HtmlTextWriterStyle.BorderColor, "#f66");
                else
                    txtMail.Style.Add(HtmlTextWriterStyle.BorderColor, "#6f6");
            }
            else
                txtMail.Style.Add(HtmlTextWriterStyle.BorderColor, "#ced4da");
        }
